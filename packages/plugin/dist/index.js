...
function Tabs({
  ...
  const [selectedValue, setSelectedValue] = useState(resolveInitialValue);
  useEffect(() => {
    if (!groupId) return;
    const handler = (e) => {
      const { detail } = e;
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "storybook-tabs__list", role: "tablist", "aria-orientation": "horizontal", children: visibleItems.map((child, index) => {
        ...
        /* @__PURE__ */ jsx("div", { className: "storybook-tabs__content", children: lazy ? tabItems.map(
          (child) => child.props.value === selectedValue ? /* @__PURE__ */ jsx(
            "div",
            {
